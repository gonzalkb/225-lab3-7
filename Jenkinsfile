pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/gonzalkb'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/gonzalkb/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('gonzalkb-225')                                                         //<------your MiamiID
    }
